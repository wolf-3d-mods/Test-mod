...
void T_BJRun2 (objtype *ob);

extern  statetype s_bj2run1;
extern  statetype s_bj2run1s;
extern  statetype s_bj2run2;
extern  statetype s_bj2run3;
extern  statetype s_bj2run3s;
extern  statetype s_bj2run4;

extern  statetype s_bj2jump1;
extern  statetype s_bj2jump2;
extern  statetype s_bj2jump3;
extern  statetype s_bj2jump4;


statetype s_bj2run1              = {false,SPR_BJ2_W1,12,(statefunc)T_BJRun2,NULL,&s_bj2run1s};
statetype s_bj2run1s             = {false,SPR_BJ2_W1,3, NULL,NULL,&s_bj2run2};
statetype s_bj2run2              = {false,SPR_BJ2_W2,8,(statefunc)T_BJRun2,NULL,&s_bj2run3};
statetype s_bj2run3              = {false,SPR_BJ2_W3,12,(statefunc)T_BJRun2,NULL,&s_bj2run3s};
statetype s_bj2run3s             = {false,SPR_BJ2_W3,3, NULL,NULL,&s_bj2run4};
statetype s_bj2run4              = {false,SPR_BJ2_W4,8,(statefunc)T_BJRun2,NULL,&s_bj2run1};


statetype s_bj2jump1             = {false,SPR_BJ2_JUMP1,14,(statefunc)T_BJJump,NULL,&s_bj2jump2};
statetype s_bj2jump2             = {false,SPR_BJ2_JUMP2,14,(statefunc)T_BJJump,(statefunc)T_BJYell,&s_bj2jump3};
statetype s_bj2jump3             = {false,SPR_BJ2_JUMP3,14,(statefunc)T_BJJump,NULL,&s_bj2jump4};
statetype s_bj2jump4             = {false,SPR_BJ2_JUMP4,300,NULL,(statefunc)T_BJDone,&s_bj2jump4};
...
void SpawnBJVictory2 (void)
{
    SpawnNewObj (player->tilex,player->tiley+1,&s_bj2run1);
    newobj->x = player->x;
    newobj->y = player->y;
    newobj->obclass = bj2obj;
    newobj->dir = north;
    newobj->temp1 = 6;                      // tiles to run forward
}
